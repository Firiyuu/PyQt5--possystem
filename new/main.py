...
import json
import os
from db_connection import insert_request, search_request

api_key = "ED816C87AAE766B419B93B24D5A0A11D" #https://upcdatabase.org/
...
def UPC_lookup(api_key,upc):
    ...
    try:
        ...
        r = requests.post('http://localhost:5000/', data=payload_data)
...
if __name__ == '__main__':
    try:
        while True:
            barcode = raw_input("Scan a barcode: ")
            UPC_lookup(api_key,barcode)
